...
# -*- coding: utf-8 -*-
#
# diffpy.cmipdf documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("diffpy.cmipdf")
except Exception:
...
modindex_common_prefix = ["diffpy.cmipdf"]
...
basename = "diffpy.cmipdf".replace(" ", "").replace(".", "")
